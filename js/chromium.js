...
(function () {
    ...
    extension.windows = {
        ...
        extension.windows = {
            open: function(options, callback) {
                console.log("open window", options);
                require('electron').remote.getGlobal('openInbox')();
                //TODO
            },

            getBackground: function(callback) {
                callback(require('electron').remote.getGlobal('backgroundPage'));
            },

            getCurrent: function(callback) {
                callback(require('electron').remote.getGlobal('mainWindow'));
            },
        ...
        window.extension.trigger = function (name, object) {
            //TODO
            console.log("trigger", name, object);
        };
    ...
    window.extension.install = function() {
        require('electron').remote.getGlobal('createInstallPage')();
    };
    extension.keepAwake = function() {};
